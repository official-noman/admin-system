...
const cardData = [
    {
        ...
        imageUrl: "/static/assets/images/small/img-4.jpg"
    },
    {
        title: "Card Title 2",
        text: "This is some example text for card 2.",
        imageUrl: "/static/assets/images/small/img-5.jpg"
    },
    {
        title: "Card Title 3",
        text: "This is some example text for card 3.",
        imageUrl: "/static/assets/images/small/img-6.jpg"
    }
];
    ...
    if (isPlaceholder) {
        return `
            <div class="col-md-6 col-xl-4">
                <div class="card mb-0">
                    <img class="card-img-top h-200px object-fit-cover" src="/static/assets/images/placeholder-3.jpg" alt="Placeholder">
                    <div class="card-body">
